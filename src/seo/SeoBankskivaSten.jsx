          ...
          content: `
            ...
            <div class="not-prose mt-6 p-5 rounded-2xl border bg-white">
              ...
              <div class="mt-3 flex gap-3 flex-wrap">
                ...
                <a href="/app?cat=Komposit" class="px-4 py-2 rounded-xl border bg-white hover:bg-gray-50 font-semibold">Se komposit i appen</a>
              </div>
            </div>
          `,
        },

        {
          ...
          content: `
            <div class="not-prose mt-2 grid md:grid-cols-2 gap-4">
              ...
              <div class="rounded-2xl border bg-white p-5">
                <div class="font-semibold text-gray-900">Jag vill ha det mest lättskött</div>
                <p class="text-sm text-gray-700 mt-2">
                ...
                <div class="mt-3 flex gap-2 flex-wrap">
                  ...
                  <a href="/app?cat=Komposit" class="px-4 py-2 rounded-xl border bg-white hover:bg-gray-50 font-semibold">Välj komposit →</a>
                </div>
              </div>
            </div>
          `,
