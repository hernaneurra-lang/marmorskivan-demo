          ...
          content: `
            <div class="not-prose mt-2 p-5 rounded-2xl border bg-emerald-50">
              ...
              <div class="mt-4 flex gap-3 flex-wrap">
                <a href="/app?cat=Komposit" class="px-5 py-2.5 rounded-xl bg-emerald-600 text-white font-semibold hover:bg-emerald-700 shadow">
        ...
        },
        {
          ...
          content: `
            ...
            <div class="not-prose mt-4 p-4 rounded-2xl border bg-white">
              ...
              <a href="/app?cat=Komposit" class="inline-flex mt-3 px-4 py-2 rounded-xl bg-emerald-600 text-white font-semibold hover:bg-emerald-700 shadow">
